...
namespace Itenso.TimePeriod {
    ...
    public sealed class DateDiff {
        ...
        public DateDiff (DateTime date):
            this (date, SafeCurrentInfo.Calendar, SafeCurrentInfo.FirstDayOfWeek) { } // DateDiff
        ...
        public DateDiff (DateTime date, Calendar calendar, DayOfWeek firstDayOfWeek,
            ...
            this (date, ClockProxy.Clock.Now, calendar, firstDayOfWeek, yearBaseMonth) { } // DateDiff

        // ----------------------------------------------------------------------
        public DateDiff (DateTime date1, DateTime date2):
            this (date1, date2, SafeCurrentInfo.Calendar, SafeCurrentInfo.FirstDayOfWeek) { } // DateDiff
        ...
        public DateDiff (TimeSpan difference):
            this (ClockProxy.Clock.Now, difference, SafeCurrentInfo.Calendar, SafeCurrentInfo.FirstDayOfWeek) { } // DateDiff

        // ----------------------------------------------------------------------
        public DateDiff (TimeSpan difference, Calendar calendar,
                DayOfWeek firstDayOfWeek, YearMonth yearBaseMonth = TimeSpec.CalendarYearStartMonth):
            this (ClockProxy.Clock.Now, difference, calendar, firstDayOfWeek, yearBaseMonth) { } // DateDiff

        // ----------------------------------------------------------------------
        public DateDiff (DateTime date1, TimeSpan difference):
            this (date1, difference, SafeCurrentInfo.Calendar, SafeCurrentInfo.FirstDayOfWeek) { } // DateDiff
