...
namespace Itenso.TimePeriod {
    ...
    public class TimeRange : ITimeRange {
        ...
        // ----------------------------------------------------------------------
        public TimeRange ():
            this (TimeSpec.MinPeriodDate, TimeSpec.MaxPeriodDate) { } // TimeRange

        // ----------------------------------------------------------------------
        internal TimeRange (bool isReadOnly = false):
            this (TimeSpec.MinPeriodDate, TimeSpec.MaxPeriodDate, isReadOnly) { } // TimeRange

        // ----------------------------------------------------------------------
        public TimeRange (DateTime moment, bool isReadOnly = false):
            this (moment, moment, isReadOnly) { } // TimeRange
