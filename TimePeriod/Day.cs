...
namespace Itenso.TimePeriod {
    ...
    public sealed class Day : DayTimeRange {
        ...
        // ----------------------------------------------------------------------
        public Day ():
            this (new TimeCalendar ()) { } // Day

        // ----------------------------------------------------------------------
        public Day (DateTime moment):
            this (moment, new TimeCalendar ()) { } // Day

        // ----------------------------------------------------------------------
        public Day (ITimeCalendar calendar):
            this (ClockProxy.Clock.Now, calendar) { } // Day

        // ----------------------------------------------------------------------
        public Day (DateTime moment, ITimeCalendar calendar):
            this (calendar.GetYear (moment), calendar.GetMonth (moment), calendar.GetDayOfMonth (moment), calendar) { } // Day

        // ----------------------------------------------------------------------
        public Day (int year, int month):
            this (year, month, new TimeCalendar ()) { } // Day

        // ----------------------------------------------------------------------
        public Day (int year, int month, ITimeCalendar calendar):
            this (year, month, 1, calendar) { } // Day

        // ----------------------------------------------------------------------
        public Day (int year, int month, int day):
            this (year, month, day, new TimeCalendar ()) { } // Day

        // ----------------------------------------------------------------------
        public Day (int year, int month, int day, ITimeCalendar calendar):
            base (year, month, day, 1, calendar) { } // Day
