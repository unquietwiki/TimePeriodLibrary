...
namespace Itenso.TimePeriod {
    ...
    public class DaySeeker : CalendarVisitor<CalendarVisitorFilter, DaySeekerContext> {
        ...
        // ------------------------------------------------------------------------
        public DaySeeker (SeekDirection seekDirection = SeekDirection.Forward, ITimeCalendar calendar = null) : this (new CalendarVisitorFilter (), seekDirection, calendar) { } // DaySeeker

        // ------------------------------------------------------------------------
        public DaySeeker (CalendarVisitorFilter filter, SeekDirection seekDirection = SeekDirection.Forward,
            ITimeCalendar calendar = null) : base (filter, TimeRange.Anytime, seekDirection, calendar) { } // DaySeeker
