...
namespace Itenso.TimePeriod {
    ...
    public sealed class Year : YearTimeRange {
        ...
        // ----------------------------------------------------------------------
        public Year ():
            this (new TimeCalendar ()) { } // Year

        // ----------------------------------------------------------------------
        public Year (ITimeCalendar calendar):
            this (ClockProxy.Clock.Now, calendar) { } // Year

        // ----------------------------------------------------------------------
        public Year (DateTime moment):
            this (moment, new TimeCalendar ()) { } // Year

        // ----------------------------------------------------------------------
        public Year (DateTime moment, ITimeCalendar calendar):
            this (TimeTool.GetYearOf (calendar.YearBaseMonth, calendar.GetYear (moment), calendar.GetMonth (moment)), calendar) { } // Year

        // ----------------------------------------------------------------------
        public Year (int year):
            this (year, new TimeCalendar ()) { } // Year

        // ----------------------------------------------------------------------
        public Year (int year, ITimeCalendar calendar):
            base (year, 1, calendar) { } // Year
